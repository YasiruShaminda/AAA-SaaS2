...
function ProjectEditor({ project, onUpdate, onSave, onDelete, onDuplicate, onBack, subscriberGroups, user }: { project: Project, onUpdate: (project: Project) => void, onSave: () => void, onDelete: () => void, onDuplicate: () => void, onBack: () => void, subscriberGroups: string[], user: { name: string, sub: string } | null }) {
...
// Main Page Component
export default function ProjectsClientPage({ user }: { user: { name: string, sub: string } | null }) {
