...
import { Fingerprint, UserPlus, Waypoints } from 'lucide-react';
...
export default function LoginPage() {
    ...
    return (
        <div className="flex h-full min-h-[calc(100vh-8rem)] items-center justify-center bg-background">
                    ...
                    <CardContent className="space-y-6">
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input id="username" placeholder="Enter your callsign" />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="password">Password</Label>
                                <Input id="password" type="password" placeholder="Enter your passcode" />
                            </div>
                        </div>
